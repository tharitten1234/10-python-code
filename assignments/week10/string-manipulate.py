...
print("- Total charaters: %d (with spaces), %d (without spaces)" % 
(len(text), text.count(' ')))

vowels = text.count('a') + text.count('A') + text.count('e') + text.count('E') + text.count('i') + text.count('I')
+ text.count('o') + text.count('O') + text.count('u') + text.count('U')
